...
class Json:
    ...
    def write(self, values):
        ...
        tmpHtml = html.replace(".id","booster_dhw")
        f.write(tmpHtml.replace(".value",str(values.get('booster_dhw')) + "") + ',')
        tmpHtml = html.replace(".id","collector_temp")
        f.write(tmpHtml.replace(".value",str(values.get('collector_temp')) + "") + ',')
        tmpHtml = html.replace(".id","heizung")
        f.write(tmpHtml.replace(".value",str(values.get('heizung')) + "") + ',')
        tmpHtml = html.replace(".id","booster_heating")
        f.write(tmpHtml.replace(".value",str(values.get('booster_heating')) + ""))
        f.write('}')
        f.close()
